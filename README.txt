...
Punchy is based on Pithy. Pithy does something very similar but uses a .NET port of YUI Compressor exclusively. Punchy allows you to change compressors and includes YUI Compressor for .NET, Microsoft Ajax Minifier, and a hacky Google Closure plugin.
